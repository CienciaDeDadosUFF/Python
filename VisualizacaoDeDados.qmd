...
![](Cadernos%20Grupo%20Python/Caderno%20Visualiza%C3%A7%C3%A3o%20de%20dados/banner01.png)
...
![](Cadernos%20Grupo%20Python/Caderno%20Visualiza%C3%A7%C3%A3o%20de%20dados/visualizacao_01_14_002.png)
...
plt.legend()                                 # Adiciona legenda ao gráfico, ele utilizará os `labels` anteriores para construir
                                             # esta legenda.
plt.show()                                   
![](Cadernos%20Grupo%20Python/Caderno%20Visualiza%C3%A7%C3%A3o%20de%20dados/visualizacao_01_24_003.png)
...
plt.show()                                   
![](Cadernos%20Grupo%20Python/Caderno%20Visualiza%C3%A7%C3%A3o%20de%20dados/visualizacao_01_25_004.png)
...
plt.show()
```                             
![](Cadernos%20Grupo%20Python/Caderno%20Visualiza%C3%A7%C3%A3o%20de%20dados/visualizacao_01_27_005.png)
...
plt.show()
```
![](Cadernos%20Grupo%20Python/Caderno%20Visualiza%C3%A7%C3%A3o%20de%20dados/visualizacao_01_33_006.png)
...
plt.show()
```
![](Cadernos%20Grupo%20Python/Caderno%20Visualiza%C3%A7%C3%A3o%20de%20dados/visualizacao_01_37_007.png)
...
plt.show()
```
![](Cadernos%20Grupo%20Python/Caderno%20Visualiza%C3%A7%C3%A3o%20de%20dados/visualizacao_01_41_008.png)
...
plt.show()
```
![](Cadernos%20Grupo%20Python/Caderno%20Visualiza%C3%A7%C3%A3o%20de%20dados/visualizacao_01_45_009.png)
...
plt.show()
```
![](Cadernos%20Grupo%20Python/Caderno%20Visualiza%C3%A7%C3%A3o%20de%20dados/visualizacao_01_46_010.png)
...
![](Cadernos%20Grupo%20Python/Caderno%20Visualiza%C3%A7%C3%A3o%20de%20dados/visualizacao_01_49_011.png)
...
plt.show()
```
![](Cadernos%20Grupo%20Python/Caderno%20Visualiza%C3%A7%C3%A3o%20de%20dados/visualizacao_01_54_012.png)
...
```
![](Cadernos%20Grupo%20Python/Caderno%20Visualiza%C3%A7%C3%A3o%20de%20dados/visualizacao_01_56_013.png)
...
sns.despine(offset=10, trim=True)
```
![](Cadernos%20Grupo%20Python/Caderno%20Visualiza%C3%A7%C3%A3o%20de%20dados/visualizacao_01_60_014.png)
...
sns.regplot(x="math score", 
            ...
            data=data);
sns.despine(offset=10, trim=True)
![](Cadernos%20Grupo%20Python/Caderno%20Visualiza%C3%A7%C3%A3o%20de%20dados/visualizacao_01_63_015.png)
...
plt.show()
```
![](Cadernos%20Grupo%20Python/Caderno%20Visualiza%C3%A7%C3%A3o%20de%20dados/visualizacao_01_65_016.png)
...
![](Cadernos%20Grupo%20Python/Caderno%20Visualiza%C3%A7%C3%A3o%20de%20dados/visualizacao_01_68_017.png)
